    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_resta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(MainActivity.this, resultadoResta.class);
                Bundle bundle = new Bundle();
                bundle.putInt("Resultado",resultado);
                i.putExtras(bundle);
                startActivity(i);
        ...
        btn_multiplicacion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(MainActivity.this, resultadoMultiplicacion.class);
                Bundle bundle = new Bundle();
                bundle.putInt("Resultado",resultado);
                i.putExtras(bundle);
                startActivity(i);
        ...
        btn_Division.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(MainActivity.this, resultadodivicion.class);
                Bundle bundle = new Bundle();
                bundle.putInt("Resultado",resultado);
                i.putExtras(bundle);
                startActivity(i);
